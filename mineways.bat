...
@rem These command-line options can be changed: make the window a different size, add more scripts to run, etc.
@rem See http://mineways.com/scripting.html#clo for more information.
