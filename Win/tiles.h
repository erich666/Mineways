...
static struct {
    ...
    { 12, 57, 434, 0, L"pink_petals_stem", L"", SWATCH_CLAMP_ALL },    // stem is along left edge
    ...
    {  0, 58, 436, 0, L"pitcher_crop_bottom_stage_3", L"", SBIT_CLAMP_TOP | SBIT_CUTOUT_GEOMETRY },    // start of 1.20
    ...
    {  0, 59, 436, 0, L"sniffer_egg_slightly_cracked_top", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },    // start of 1.20
