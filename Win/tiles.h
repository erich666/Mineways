...
static struct {
    ...
    int txrY;
	int typeForMtl;	// representative type, usually the first block to use this tile. Mostly needed for knowing about alpha for the tile; use crossCorrelate code in _DEBUG in Mineways to help build this column
    int dataValForMtl;
...
// TODO: someday, just read from the unzipped texture pack itself, using the proper paths.
    ...
    {  0,  0,   2, 0, L"grass_block_top", L"grass_top", SWATCH_REPEAT_ALL },	// tinted by grass.png
    {  1,  0,   1, 0, L"stone", L"", SWATCH_REPEAT_ALL },
    {  2,  0,   3, 0, L"dirt", L"", SWATCH_REPEAT_ALL },
    {  3,  0,   2, 0, L"grass_block_side", L"grass_side", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    {  4,  0,   5, 0, L"oak_planks", L"planks_oak", SWATCH_REPEAT_ALL },
    {  5,  0,  43, 0, L"stone_slab_side", L"", SWATCH_REPEAT_ALL }, // no longer used? we substitute 11,23
    {  6,  0,  43, 0, L"stone_slab_top", L"", SWATCH_REPEAT_ALL }, // no longer used? we substitute 10,23
    ...
    {  9,  1,  54, 0, L"MWO_chest_top", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },	// taken by chest. Find chests in \assets\minecraft\textures\entity\chest and include in blocks\chest subdirectory
    { 10,  1,  54, 0, L"MWO_chest_side", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },	// taken by chest
    { 11,  1,  54, 0, L"MWO_chest_front", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },	// taken by chest
    ...
    {  7,  2,  31, 0, L"grass", L"tallgrass", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    ...
    {  4,  3,  18, 0, L"oak_leaves", L"leaves_oak", SWATCH_REPEAT_ALL | SBIT_DECAL | SBIT_LEAVES },
    ...
    {  8,  3,  31, 0, L"fern", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    ...
    { 13,  3,  61, 0, L"furnace_front_on", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    { 14,  3,  61, 0, L"furnace_top", L"", SWATCH_REPEAT_ALL },	// also used for dispenser
    ...
    {  4,  4,  80, 0, L"grass_block_snow", L"grass_side_snowed", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    ...
    { 12,  4, 111, 0, L"lily_pad", L"waterlily", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	...
	{  1,  6,  64, 0, L"oak_door_bottom", L"door_wood_lower", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
	{  2,  6,  71, 0, L"iron_door_bottom", L"door_iron_lower", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
	{  3,  6,  76, 0, L"redstone_torch", L"redstone_torch_on", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  4,  6,  98, 0, L"mossy_stone_bricks", L"stonebrick_mossy", SWATCH_REPEAT_ALL },
	{  5,  6,  98, 0, L"cracked_stone_bricks", L"stonebrick_cracked", SWATCH_REPEAT_ALL },
	...
	{ 13,  6,  33, 0, L"piston_bottom", L"", SWATCH_REPEAT_ALL },
	{ 14,  6,  33, 0, L"piston_inner", L"", SWATCH_REPEAT_ALL },
	{ 15,  6, 105, 0, L"melon_stem", L"melon_stem_disconnected", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	...
	{  7,  7,  91, 0, L"carved_pumpkin", L"pumpkin_face_off", SWATCH_REPEAT_ALL },
	...
	{ 15,  7, 105, 0, L"attached_melon_stem", L"melon_stem_connected", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	...
	{  4,  8,  18, 0, L"spruce_leaves", L"leaves_spruce", SWATCH_REPEAT_ALL | SBIT_DECAL | SBIT_LEAVES },
	...
	{ 13,  8,  99, 0, L"mushroom_stem", L"mushroom_block_skin_stem", SWATCH_REPEAT_ALL },
	{ 14,  8,  99, 0, L"mushroom_block_inside", L"", SWATCH_REPEAT_ALL },
	{ 15,  8, 106, 0, L"vine", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },	// grayscale
    ...
    {  5, 10,  55, 0, L"redstone_dust_line1", L"", SWATCH_REPEAT_ALL | SBIT_DECAL },	// horizontal, rotated
    ...
    {  4, 11,  55, 0, L"redstone_dust_dot", L"", SWATCH_REPEAT_ALL | SBIT_DECAL },
    {  5, 11, 162, 0, L"acacia_log", L"log_acacia", 0x0 },	// ADD-IN 1.7.2
    ...
    {  9, 11,   6, 0, L"item_frame", L"itemframe_background", SWATCH_REPEAT_ALL },	// frame around item, unimplemented, should really never be output
    ...
    { 14, 11, 104, 0, L"pumpkin_stem", L"pumpkin_stem_disconnected", SBIT_CLAMP_BOTTOM | SBIT_DECAL },	// ADD-IN
    { 15, 11, 104, 0, L"attached_pumpkin_stem", L"pumpkin_stem_connected", SBIT_CLAMP_BOTTOM | SBIT_DECAL },	// ADD-IN
    ...
    {  4, 12,  18, 0, L"jungle_leaves", L"leaves_jungle", SWATCH_REPEAT_ALL | SBIT_DECAL | SBIT_LEAVES },
    {  5, 12, 179, 0, L"chiseled_red_sandstone", L"red_sandstone_carved", SWATCH_REPEAT_ALL },	// ADD-IN 1.8
    ...
    { 10, 13, 130, 0, L"MWO_ender_chest_top", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 11, 13, 130, 0, L"MWO_ender_chest_side", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 12, 13, 130, 0, L"MWO_ender_chest_front", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 13, 13,  18, 0, L"birch_leaves", L"leaves_birch", SWATCH_REPEAT_ALL | SBIT_DECAL | SBIT_LEAVES },	// ADD-IN
    { 14, 13, 179, 0, L"red_sandstone", L"red_sandstone_normal", SWATCH_REPEAT_ALL },	// ADD-IN 1.8
    { 15, 13,   8, 0, L"water_still", L"", SWATCH_REPEAT_ALL },
	...
	{  5, 14,  24, 0, L"chiseled_sandstone", L"sandstone_carved", SWATCH_REPEAT_ALL },
    ...
    {  1, 15,  75, 0, L"MWO_flattened_redstone_torch_top", L"", SWATCH_REPEAT_ALL | SBIT_DECAL },	// MANUFACTURED used for flattened redstone torch top, on; not used in rendering, but 3D printing uses for composites for torches from above
    {  2, 15,  76, 0, L"MWO_flattened_redstone_torch_top_off", L"", SWATCH_REPEAT_ALL | SBIT_DECAL },	// MANUFACTURED used for flattened redstone torch top, off; not used in rendering, but 3D printing uses for composites for torches from above
    ...
    {  5, 15, 151, 0, L"daylight_detector_side", L"", SWATCH_REPEAT_ALL },	// destroy, etc. unused
    ...
    { 15, 15,  10, 0, L"lava_still", L"", SWATCH_REPEAT_ALL },
    ...
    {  1, 17, 155, 0, L"quartz_block_bottom", L"", SWATCH_REPEAT_ALL },    // despite the name, this is used on all sides of the smooth quartz block and nothing else
    ...
    {  9, 17, 157, 0, L"activator_rail", L"rail_activator_powered", SWATCH_TILE_BOTTOM_AND_TOP | SBIT_DECAL },
    ...
    {  6, 18, 175, 0, L"tall_grass_bottom", L"double_plant_grass_bottom", SWATCH_CLAMP_BOTTOM_AND_TOP | SBIT_DECAL },
    {  7, 18, 175, 0, L"tall_grass_top", L"double_plant_grass_top", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  8, 18, 175, 0, L"large_fern_bottom", L"double_plant_fern_bottom", SWATCH_CLAMP_BOTTOM_AND_TOP | SBIT_DECAL },
    {  9, 18, 175, 0, L"large_fern_top", L"double_plant_fern_top", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    ...
    {  9, 19, 161, 0, L"acacia_leaves", L"leaves_acacia", SWATCH_REPEAT_ALL | SBIT_DECAL | SBIT_LEAVES },	// ADD-IN 1.7.2
    { 10, 19, 179, 0, L"cut_red_sandstone", L"red_sandstone_smooth", SWATCH_REPEAT_ALL },	// ADD-IN 1.8
    { 11, 19, 161, 0, L"dark_oak_leaves", L"leaves_big_oak", SWATCH_REPEAT_ALL | SBIT_DECAL | SBIT_LEAVES },	// ADD-IN 1.7.2
    ...
    { 14, 19, 162, 0, L"dark_oak_log", L"log_big_oak", SWATCH_REPEAT_ALL },	// ADD-IN 1.7.2
    { 15, 19, 162, 0, L"dark_oak_log_top", L"log_big_oak_top", SWATCH_REPEAT_ALL },	// ADD-IN 1.7.2
    ...
    {  5, 22, 329, 0, L"polished_andesite", L"stone_andesite_smooth", SWATCH_REPEAT_ALL },
    {  6, 22, 329, 0, L"diorite", L"stone_diorite", SWATCH_REPEAT_ALL },
    {  7, 22, 329, 0, L"polished_diorite", L"stone_diorite_smooth", SWATCH_REPEAT_ALL },
    {  8, 22, 329, 0, L"granite", L"stone_granite", SWATCH_REPEAT_ALL },
    {  9, 22, 329, 0, L"polished_granite", L"stone_granite_smooth", SWATCH_REPEAT_ALL },
    ...
    {  0, 23, 193, 0, L"spruce_door_bottom", L"door_spruce_lower", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    ...
    {  8, 23, 197, 0, L"dark_oak_door_bottom", L"door_dark_oak_lower", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    {  9, 23, 197, 0, L"dark_oak_door_top", L"door_dark_oak_upper", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    { 10, 23,  43, 0, L"smooth_stone", L"", SWATCH_REPEAT_ALL },	// now reused for 1.14 - was top of banner; NOTE: this looks a heckuva lot like "stone_slab_top" - which gets used? This one, so it's used for 6,0
    { 11, 23,  43, 0, L"smooth_stone_slab_side", L"", SWATCH_REPEAT_ALL },	// now reused for 1.14 - was bottom of banner; NOTE: this looks a heckuva lot like "stone_slab_side" - which gets used? This one, so it's used for 5,0
    ...
    {  1, 24, 202, 0, L"purpur_pillar", L"", SWATCH_REPEAT_ALL },
    ...
    {  9, 24, 208, 0, L"grass_path_side", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_ALPHA_OVERLAY },
    { 10, 24, 137, 0, L"command_block_front", L"", SWATCH_REPEAT_ALL },
    { 11, 24, 137, 0, L"command_block_back", L"", SWATCH_REPEAT_ALL },  // also "commandBlock", but no room...
    { 12, 24, 137, 0, L"command_block_side", L"", SWATCH_REPEAT_ALL },
    { 13, 24, 137, 0, L"command_block_conditional", L"", SWATCH_REPEAT_ALL },
    ...
    { 15, 25,   9, 0, L"water_overlay", L"", SWATCH_REPEAT_ALL },    // 1.9 - water looks like this through glass.
    ...
    {  6, 26,  55, 0, L"MWO_redstone_dust_four_way", L"", SWATCH_REPEAT_ALL | SBIT_DECAL },	// MANUFACTURED 4 way redstone wire - reserved
    {  7, 26,  54, 0, L"MWO_chest_latch", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
    {  8, 26,   8, 0, L"water_flow", L"", SWATCH_REPEAT_ALL },	// special: double-wide
    {  9, 26,  10, 0, L"lava_flow", L"", SWATCH_REPEAT_ALL },		// special: double-wide
    { 10, 26,  55, 0, L"MWO_redstone_dust_line0_off", L"", SWATCH_CLAMP_ALL | SBIT_DECAL },	// MANUFACTURED REDSTONE_WIRE_VERT_OFF
    { 11, 26,  55, 0, L"MWO_redstone_dust_line1_off", L"", SWATCH_CLAMP_ALL | SBIT_DECAL },	// MANUFACTURED REDSTONE_WIRE_HORIZ_OFF
    ...
    {  8, 33, 313, 0, L"dried_kelp_side", L"", SWATCH_REPEAT_ALL },
    ...
    { 14, 33, 309, 0, L"tall_seagrass_bottom", L"", SWATCH_CLAMP_BOTTOM_AND_TOP | SBIT_DECAL },
	...
	{  1, 35, 316, 0, L"dead_tube_coral_block", L"", SWATCH_REPEAT_ALL },
	{  2, 35, 316, 0, L"dead_brain_coral_block", L"", SWATCH_REPEAT_ALL },
	{  3, 35, 316, 0, L"dead_bubble_coral_block", L"", SWATCH_REPEAT_ALL },
	{  4, 35, 316, 0, L"dead_fire_coral_block", L"", SWATCH_REPEAT_ALL },
	{  5, 35, 316, 0, L"dead_horn_coral_block", L"", SWATCH_REPEAT_ALL },
	{  6, 35, 315, 0, L"tube_coral_block", L"", SWATCH_REPEAT_ALL },
	{  7, 35, 315, 0, L"brain_coral_block", L"", SWATCH_REPEAT_ALL },
	{  8, 35, 315, 0, L"bubble_coral_block", L"", SWATCH_REPEAT_ALL },
	{  9, 35, 315, 0, L"fire_coral_block", L"", SWATCH_REPEAT_ALL },
	{ 10, 35, 315, 0, L"horn_coral_block", L"", SWATCH_REPEAT_ALL },
	{ 11, 35, 317, 0, L"tube_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 12, 35, 317, 0, L"brain_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 13, 35, 317, 0, L"bubble_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 14, 35, 317, 0, L"fire_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 15, 35, 317, 0, L"horn_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  0, 36, 318, 0, L"tube_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  1, 36, 318, 0, L"brain_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  2, 36, 318, 0, L"bubble_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  3, 36, 318, 0, L"fire_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  4, 36, 318, 0, L"horn_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  5, 36, 319, 0, L"dead_tube_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  6, 36, 319, 0, L"dead_brain_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  7, 36, 319, 0, L"dead_bubble_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  8, 36, 319, 0, L"dead_fire_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  9, 36, 319, 0, L"dead_horn_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 10, 36, 324, 0, L"turtle_egg", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	...
	{ 14, 36, 325, 0, L"dead_tube_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 15, 36, 325, 0, L"dead_brain_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  0, 37, 325, 0, L"dead_bubble_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  1, 37, 325, 0, L"dead_fire_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  2, 37, 325, 0, L"dead_horn_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  3, 37,  38, 0, L"cornflower", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  4, 37,  38, 0, L"lily_of_the_valley", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  5, 37,  38, 0, L"wither_rose", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  6, 37, 328, 0, L"bamboo_large_leaves", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  7, 37, 328, 0, L"bamboo_singleleaf", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  8, 37, 328, 0, L"bamboo_small_leaves", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  9, 37, 328, 0, L"bamboo_stage0", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },	// X decal
	{ 10, 37, 328, 0, L"bamboo_stalk", L"", SWATCH_CLAMP_ALL },	// geometry - this particular one does not need SBIT_CUTOUT_GEOMETRY as it fills the tile
	...
	{  9, 38,  61, 0, L"blast_furnace_front", L"", SWATCH_REPEAT_ALL },
	...
	{ 14, 38, 332, 0, L"composter_compost", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{ 15, 38, 332, 0, L"composter_ready", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{  0, 39, 339, 0, L"campfire_fire", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	...
	{  3, 39,  58, 0, L"cartography_table_top", L"cartography_top_bottom", SWATCH_REPEAT_ALL },
	...
	{ 14, 40,  61, 0, L"smoker_front", L"", SWATCH_REPEAT_ALL },
	...
	{  5, 41, 344, 0, L"stonecutter_side", L"", SWATCH_CLAMP_ALL_BUT_TOP | SBIT_CUTOUT_GEOMETRY },
	{  6, 41, 344, 0, L"stonecutter_bottom", L"", SWATCH_REPEAT_ALL },
	{  7, 41, 344, 0, L"stonecutter_saw", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  8, 41, 345, 0, L"bee_nest_bottom", L"", SWATCH_REPEAT_ALL },
	{  9, 41, 345, 0, L"bee_nest_front", L"", SWATCH_REPEAT_ALL },
	{ 10, 41, 345, 0, L"bee_nest_front_honey", L"", SWATCH_REPEAT_ALL },
	{ 11, 41, 345, 0, L"bee_nest_side", L"", SWATCH_REPEAT_ALL },
	{ 12, 41, 345, 0, L"bee_nest_top", L"", SWATCH_REPEAT_ALL },
	{ 13, 41, 345, 0, L"beehive_end", L"", SWATCH_REPEAT_ALL },
	{ 14, 41, 345, 0, L"beehive_front", L"", SWATCH_REPEAT_ALL },
	{ 15, 41, 345, 0, L"beehive_front_honey", L"", SWATCH_REPEAT_ALL },
	{  0, 42, 345, 0, L"beehive_side", L"", SWATCH_REPEAT_ALL },
	{  1, 42,  58, 0, L"honey_block_bottom", L"", SWATCH_REPEAT_ALL },
	{  2, 42,  58, 0, L"honey_block_side", L"", SWATCH_REPEAT_ALL },
	{  3, 42,  58, 0, L"honey_block_top", L"", SWATCH_REPEAT_ALL },
	{  4, 42, 334, 0, L"honeycomb_block", L"", SWATCH_REPEAT_ALL },
    ...
    {  0, 43,  58, 0, L"crimson_stem_top", L"", SWATCH_REPEAT_ALL },	// more like a log
    {  1, 43, 345, 0, L"crimson_stem", L"", SWATCH_REPEAT_ALL },	// more like a log
    {  2, 43,  58, 0, L"crimson_nylium", L"", SWATCH_REPEAT_ALL },
    {  3, 43,  58, 0, L"crimson_nylium_side", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    {  4, 43, 334, 0, L"crimson_fungus", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    ...
    { 10, 43,   6, 0, L"crimson_door_top", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    { 11, 43,   6, 0, L"crimson_door_bottom", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    ...
    { 14, 43,   6, 0, L"weeping_vines", L"", SBIT_CLAMP_TOP | SBIT_DECAL },	// bizarrely, upside down
    { 15, 43,   6, 0, L"weeping_vines_plant", L"", SWATCH_CLAMP_BOTTOM_AND_TOP | SBIT_DECAL },
    {  0, 44,  58, 0, L"warped_stem_top", L"", SWATCH_REPEAT_ALL },	// more like a log
    {  1, 44, 345, 0, L"warped_stem", L"", SWATCH_REPEAT_ALL },	// more like a log				
    {  2, 44,  58, 0, L"warped_nylium", L"", SWATCH_REPEAT_ALL },
    {  3, 44,  58, 0, L"warped_nylium_side", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    {  4, 44, 334, 0, L"warped_fungus", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    ...
    { 10, 44,   6, 0, L"warped_door_top", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    { 11, 44,   6, 0, L"warped_door_bottom", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    ...
    { 14, 44,   6, 0, L"twisting_vines", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    { 15, 44,   6, 0, L"twisting_vines_plant", L"", SWATCH_CLAMP_BOTTOM_AND_TOP | SBIT_DECAL },
    {  0, 45, 345, 0, L"ancient_debris_top", L"", SWATCH_REPEAT_ALL },
    {  1, 45,  58, 0, L"ancient_debris_side", L"", SWATCH_REPEAT_ALL },
    {  2, 45,  58, 0, L"crying_obsidian", L"", SWATCH_REPEAT_ALL },
    {  3, 45,   6, 0, L"respawn_anchor_top", L"", SWATCH_REPEAT_ALL },
    {  4, 45,   6, 0, L"respawn_anchor_top_off", L"", SWATCH_REPEAT_ALL },
    {  5, 45, 334, 0, L"respawn_anchor_side0", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    {  6, 45,   6, 1, L"respawn_anchor_side1", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    {  7, 45,   6, 2, L"respawn_anchor_side2", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    {  8, 45,   6, 3, L"respawn_anchor_side3", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    {  9, 45,   6, 4, L"respawn_anchor_side4", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    { 10, 45,  58, 0, L"respawn_anchor_bottom", L"", SWATCH_REPEAT_ALL },
    ...
    {  0, 46, 345, 0, L"blackstone_top", L"", SWATCH_REPEAT_ALL },
    {  1, 46,  58, 0, L"blackstone", L"", SWATCH_REPEAT_ALL },
    {  2, 46,  58, 0, L"chiseled_polished_blackstone", L"", SWATCH_REPEAT_ALL },
    {  3, 46,  58, 0, L"cracked_polished_blackstone_bricks", L"", SWATCH_REPEAT_ALL },
    {  4, 46, 334, 0, L"polished_blackstone", L"", SWATCH_REPEAT_ALL },
    ...
    { 15, 46,   6, 0, L"", L"", SWATCH_REPEAT_ALL },	// unused
};
