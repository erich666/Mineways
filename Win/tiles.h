...
static struct {
    ...
    { 6, 8, L"MW_bed_feet_top", L"", SWATCH_CLAMP_ALL },
    { 7, 8, L"MW_bed_head_top", L"", SWATCH_CLAMP_ALL },
    ...
    { 5, 9, L"MW_bed_feet_end", L"", SWATCH_CLAMP_ALL_BUT_TOP | SBIT_CUTOUT_GEOMETRY },
    { 6, 9, L"MW_bed_feet_side", L"", SWATCH_CLAMP_ALL_BUT_TOP | SBIT_CUTOUT_GEOMETRY },
    { 7, 9, L"MW_bed_head_side", L"", SWATCH_CLAMP_ALL_BUT_TOP | SBIT_CUTOUT_GEOMETRY },
    { 8, 9, L"MW_bed_head_end", L"", SWATCH_CLAMP_ALL_BUT_TOP | SBIT_CUTOUT_GEOMETRY },
