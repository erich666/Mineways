...
static struct {
    ...
    {  4,11, L"redstone_dust_dot", L"", SWATCH_REPEAT_ALL }, // MANUFACTURED was redstone_dust_cross_overlay, redstoneDust_cross_overlay - we now use it for a redstone dot
    ...
    {  8,11, L"MW_END_PORTAL", L"commandBlock", SWATCH_REPEAT_ALL },    // custom
    ...
    { 12,23, L"end_rod", L"", SWATCH_CLAMP_ALL },
    ...
    { 14,25, L"MW_BARRIER", L"", SWATCH_CLAMP_ALL },
    { 15,25, L"water_overlay", L"", SWATCH_REPEAT_ALL },    // 1.9 - water looks like this through glass.
};

/* todo:
WARNING: redstone_dust_line0.png is a tile name that TileMaker does not understand. Perhaps you need to rename it?
WARNING: redstone_dust_line1.png is a tile name that TileMaker does not understand. Perhaps you need to rename it?
WARNING: redstone_dust_overlay.png is a tile name that TileMaker does not understand. Perhaps you need to rename it?
WARNING: water_overlay.png - in 1.9 TODOTODO this tile is used next to glass blocks instead of flowing water.
*/
...
const TCHAR * gUnneeded[]={
    ...
    L"fire_layer_1",
    L"lava_flow",
    //L"redstone_dust_cross_overlay", TODOTODO 1.9
    //L"redstone_dust_line_overlay", TODOTODO 1.9
    L"water_flow",
    L"structure_block", // surprisingly, it's not used
    // older names
