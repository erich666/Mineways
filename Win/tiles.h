...
// TODO: someday, just read from the unzipped texture pack itself, using the proper paths.
    ...
    {  4, 12,   0, L"jungle_leaves", L"leaves_jungle", SWATCH_REPEAT_ALL | SBIT_DECAL | SBIT_LEAVES },
    {  5, 12,   0, L"chiseled_red_sandstone", L"red_sandstone_carved", SWATCH_REPEAT_ALL },	// ADD-IN 1.8
    ...
    {  0, 13,   0, L"sandstone_bottom", L"", SWATCH_REPEAT_ALL },
    ...
    {  5, 13,   0, L"chiseled_stone_bricks", L"stonebrick_carved", SWATCH_REPEAT_ALL },
    {  6, 13, 135, L"birch_planks", L"planks_birch", SWATCH_REPEAT_ALL },
    {  7, 13, 145, L"anvil", L"anvil_base", SWATCH_REPEAT_ALL },
    {  8, 13,   0, L"chipped_anvil_top", L"anvil_top_damaged_1", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  9, 13,   0, L"MWO_ender_chest_latch", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
    { 10, 13, 130, L"MWO_ender_chest_top", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 11, 13,   0, L"MWO_ender_chest_side", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 12, 13,   0, L"MWO_ender_chest_front", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 13, 13,   0, L"birch_leaves", L"leaves_birch", SWATCH_REPEAT_ALL | SBIT_DECAL | SBIT_LEAVES },	// ADD-IN
    { 14, 13,   0, L"red_sandstone", L"red_sandstone_normal", SWATCH_REPEAT_ALL },	// ADD-IN 1.8
	...
	{  2, 14,   0, L"nether_wart_stage0", L"nether_wart_stage_0", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  3, 14,   0, L"nether_wart_stage1", L"nether_wart_stage_1", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  4, 14, 115, L"nether_wart_stage2", L"nether_wart_stage_2", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  5, 14,   0, L"chiseled_sandstone", L"sandstone_carved", SWATCH_REPEAT_ALL },
	{  6, 14,   0, L"cut_sandstone", L"sandstone_smooth", SWATCH_REPEAT_ALL },
	{  7, 14,   0, L"anvil_top", L"anvil_top_damaged_0", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
	{  8, 14,   0, L"damaged_anvil_top", L"anvil_top_damaged_2", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
	{  9, 14,   0, L"MWO_double_chest_top_left", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },	// was unused, ender chest moved to here
    { 10, 14,   0, L"MWO_double_chest_top_right", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },	// was unused, ender chest moved to here
    ...
    { 13, 14,   0, L"coal_block", L"", SWATCH_REPEAT_ALL },
    { 14, 14, 149, L"comparator", L"comparator_off", SWATCH_REPEAT_ALL },
    { 15, 14, 150, L"comparator_on", L"", SWATCH_REPEAT_ALL },
    {  0, 15,   0, L"MWO_flattened_torch_top", L"", SWATCH_REPEAT_ALL | SBIT_DECAL },	// MANUFACTURED used for flattened torch top; not used in rendering, but 3D printing uses for composites for torches from above
    {  1, 15,   0, L"MWO_flattened_redstone_torch_top", L"", SWATCH_REPEAT_ALL | SBIT_DECAL },	// MANUFACTURED used for flattened redstone torch top, on; not used in rendering, but 3D printing uses for composites for torches from above
    {  2, 15,   0, L"MWO_flattened_redstone_torch_top_off", L"", SWATCH_REPEAT_ALL | SBIT_DECAL },	// MANUFACTURED used for flattened redstone torch top, off; not used in rendering, but 3D printing uses for composites for torches from above
    {  3, 15,   0, L"MWO_redstone_dust_angled", L"", SWATCH_REPEAT_ALL | SBIT_DECAL },	// MANUFACTURED used for angled redstone wire
    {  4, 15,   0, L"MWO_redstone_dust_three_way", L"", SWATCH_REPEAT_ALL | SBIT_DECAL },	// MANUFACTURED used for three-way redstone wire
    {  5, 15,   0, L"daylight_detector_side", L"", SWATCH_REPEAT_ALL },	// destroy, etc. unused
    {  6, 15, 151, L"daylight_detector_top", L"", SWATCH_REPEAT_ALL },
    {  7, 15,   0, L"dropper_front", L"dropper_front_horizontal", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    {  8, 15,   0, L"dropper_front_vertical", L"", SWATCH_REPEAT_ALL },
    {  9, 15,   0, L"hay_block_side", L"", SWATCH_REPEAT_ALL },
    { 10, 15, 170, L"hay_block_top", L"", SWATCH_REPEAT_ALL },
    { 11, 15,   0, L"hopper_inside", L"", SWATCH_REPEAT_ALL },
    { 12, 15,   0, L"hopper_outside", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    ...
    {  1, 17,   0, L"quartz_block_bottom", L"", SWATCH_REPEAT_ALL },
    {  2, 17,   0, L"chiseled_quartz_block_top", L"quartz_block_chiseled_top", SWATCH_REPEAT_ALL },
    {  3, 17,   0, L"chiseled_quartz_block", L"quartz_block_chiseled", SWATCH_REPEAT_ALL },
    {  4, 17,   0, L"quartz_pillar_top", L"quartz_block_lines_top", SWATCH_REPEAT_ALL },
    {  5, 17,   0, L"quartz_pillar", L"quartz_block_lines", SWATCH_REPEAT_ALL },
    {  6, 17,   0, L"quartz_block_side", L"", SWATCH_REPEAT_ALL },
    {  7, 17, 155, L"quartz_block_top", L"", SWATCH_REPEAT_ALL },
    {  8, 17, 153, L"nether_quartz_ore", L"quartz_ore", SWATCH_REPEAT_ALL },
    {  9, 17,   0, L"activator_rail", L"rail_activator_powered", SWATCH_TILE_BOTTOM_AND_TOP | SBIT_DECAL },
    { 10, 17, 157, L"activator_rail_on", L"rail_activator", SWATCH_TILE_BOTTOM_AND_TOP | SBIT_DECAL },
    { 11, 17,   0, L"detector_rail_on", L"rail_detector_powered", SWATCH_TILE_BOTTOM_AND_TOP | SBIT_DECAL },
    // 1.7
    { 12, 17, 174, L"packed_ice", L"ice_packed", SWATCH_REPEAT_ALL },
    { 13, 17,   0, L"red_sand", L"", SWATCH_REPEAT_ALL },
    { 14, 17,   0, L"podzol_side", L"dirt_podzol_side", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    { 15, 17,   0, L"podzol_top", L"dirt_podzol_top", SWATCH_REPEAT_ALL },
    ...
    {  0, 19,   0, L"blue_orchid", L"flower_blue_orchid", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  1, 19,   0, L"allium", L"flower_allium", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  2, 19,   0, L"azure_bluet", L"flower_houstonia", SBIT_CLAMP_BOTTOM | SBIT_DECAL },	// azure bluet
    {  3, 19,   0, L"red_tulip", L"flower_tulip_red", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  4, 19,   0, L"orange_tulip", L"flower_tulip_orange", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  5, 19,   0, L"white_tulip", L"flower_tulip_white", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  6, 19,   0, L"pink_tulip", L"flower_tulip_pink", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  7, 19,   0, L"oxeye_daisy", L"flower_oxeye_daisy", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  8, 19,   0, L"seagrass", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },	// 1.13 - was flower_paeonia - no longer used TODO
    {  9, 19, 161, L"acacia_leaves", L"leaves_acacia", SWATCH_REPEAT_ALL | SBIT_DECAL | SBIT_LEAVES },	// ADD-IN 1.7.2
    { 10, 19,   0, L"cut_red_sandstone", L"red_sandstone_smooth", SWATCH_REPEAT_ALL },	// ADD-IN 1.8
    { 11, 19, 161, L"dark_oak_leaves", L"leaves_big_oak", SWATCH_REPEAT_ALL | SBIT_DECAL | SBIT_LEAVES },	// ADD-IN 1.7.2
    { 12, 19,   0, L"red_sandstone_top", L"", SWATCH_REPEAT_ALL },	// ADD-IN 1.8
    ...
    {  1, 20,   0, L"orange_stained_glass", L"glass_orange", SWATCH_REPEAT_ALL },
    {  2, 20,   0, L"magenta_stained_glass", L"glass_magenta", SWATCH_REPEAT_ALL },
    {  3, 20,   0, L"light_blue_stained_glass", L"glass_light_blue", SWATCH_REPEAT_ALL },
    {  4, 20,   0, L"yellow_stained_glass", L"glass_yellow", SWATCH_REPEAT_ALL },
    {  5, 20,   0, L"lime_stained_glass", L"glass_lime", SWATCH_REPEAT_ALL },
    {  6, 20,   0, L"pink_stained_glass", L"glass_pink", SWATCH_REPEAT_ALL },
    {  7, 20,   0, L"gray_stained_glass", L"glass_gray", SWATCH_REPEAT_ALL },
    {  8, 20,   0, L"light_gray_stained_glass", L"glass_silver", SWATCH_REPEAT_ALL },
    {  9, 20,   0, L"cyan_stained_glass", L"glass_cyan", SWATCH_REPEAT_ALL },
    { 10, 20,   0, L"purple_stained_glass", L"glass_purple", SWATCH_REPEAT_ALL },
    { 11, 20,   0, L"blue_stained_glass", L"glass_blue", SWATCH_REPEAT_ALL },
    { 12, 20,   0, L"brown_stained_glass", L"glass_brown", SWATCH_REPEAT_ALL },
    { 13, 20,   0, L"green_stained_glass", L"glass_green", SWATCH_REPEAT_ALL },
    { 14, 20,   0, L"red_stained_glass", L"glass_red", SWATCH_REPEAT_ALL },
    { 15, 20,   0, L"black_stained_glass", L"glass_black", SWATCH_REPEAT_ALL },
    {  0, 21,   0, L"white_stained_glass_pane_top", L"glass_pane_top_white", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  1, 21,   0, L"orange_stained_glass_pane_top", L"glass_pane_top_orange", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  2, 21,   0, L"magenta_stained_glass_pane_top", L"glass_pane_top_magenta", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  3, 21,   0, L"light_blue_stained_glass_pane_top", L"glass_pane_top_light_blue", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  4, 21,   0, L"yellow_stained_glass_pane_top", L"glass_pane_top_yellow", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  5, 21,   0, L"lime_stained_glass_pane_top", L"glass_pane_top_lime", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  6, 21,   0, L"pink_stained_glass_pane_top", L"glass_pane_top_pink", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  7, 21,   0, L"gray_stained_glass_pane_top", L"glass_pane_top_gray", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  8, 21,   0, L"light_gray_stained_glass_pane_top", L"glass_pane_top_silver", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  9, 21,   0, L"cyan_stained_glass_pane_top", L"glass_pane_top_cyan", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 10, 21,   0, L"purple_stained_glass_pane_top", L"glass_pane_top_purple", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 11, 21,   0, L"blue_stained_glass_pane_top", L"glass_pane_top_blue", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 12, 21,   0, L"brown_stained_glass_pane_top", L"glass_pane_top_brown", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 13, 21,   0, L"green_stained_glass_pane_top", L"glass_pane_top_green", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 14, 21,   0, L"red_stained_glass_pane_top", L"glass_pane_top_red", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 15, 21,   0, L"black_stained_glass_pane_top", L"glass_pane_top_black", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    ...
    {  5, 22,   0, L"polished_andesite", L"stone_andesite_smooth", SWATCH_REPEAT_ALL },
    {  6, 22,   0, L"diorite", L"stone_diorite", SWATCH_REPEAT_ALL },
    {  7, 22,   0, L"polished_diorite", L"stone_diorite_smooth", SWATCH_REPEAT_ALL },
    {  8, 22,   0, L"granite", L"stone_granite", SWATCH_REPEAT_ALL },
    {  9, 22,   0, L"polished_granite", L"stone_granite_smooth", SWATCH_REPEAT_ALL },
    ...
    { 15, 22,   0, L"wet_sponge", L"sponge_wet", SWATCH_REPEAT_ALL },
    {  0, 23,   0, L"spruce_door_bottom", L"door_spruce_lower", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    {  1, 23, 193, L"spruce_door_top", L"door_spruce_upper", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    {  2, 23,   0, L"birch_door_bottom",  L"door_birch_lower", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    {  3, 23, 194, L"birch_door_top", L"door_birch_upper", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    {  4, 23,   0, L"jungle_door_bottom", L"door_jungle_lower", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    {  5, 23, 195, L"jungle_door_top", L"door_jungle_upper", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    {  6, 23,   0, L"acacia_door_bottom", L"door_acacia_lower", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    {  7, 23, 196, L"acacia_door_top", L"door_acacia_upper", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    {  8, 23,   0, L"dark_oak_door_bottom", L"door_dark_oak_lower", SWATCH_REPEAT_SIDES_ELSE_CLAMP },
    ...
    { 11, 23,   0, L"smooth_stone_slab_side", L"", SWATCH_REPEAT_ALL },	// now reused for 1.14 - was bottom of banner; NOTE: this looks a heckuva lot like "stone_slab_side" - which gets used? This one, so it's used for 5,0
    ...
    { 15, 23,   0, L"chorus_flower_dead", L"", SWATCH_REPEAT_ALL },
    {  0, 24, 201, L"purpur_block", L"", SWATCH_REPEAT_ALL },
    {  1, 24,   0, L"purpur_pillar", L"", SWATCH_REPEAT_ALL },
    {  2, 24, 202, L"purpur_pillar_top", L"", SWATCH_REPEAT_ALL },
    {  3, 24, 206, L"end_stone_bricks", L"end_bricks", SWATCH_REPEAT_ALL },
    {  4, 24,   0, L"beetroots_stage0", L"beetroots_stage_0", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  5, 24,   0, L"beetroots_stage1", L"beetroots_stage_1", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  6, 24,   0, L"beetroots_stage2", L"beetroots_stage_2", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    ...
    {  9, 24,   0, L"grass_path_side", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_ALPHA_OVERLAY },
    { 10, 24, 137, L"command_block_front", L"", SWATCH_REPEAT_ALL },
    { 11, 24,   0, L"command_block_back", L"", SWATCH_REPEAT_ALL },  // also "commandBlock", but no room...
    { 12, 24,   0, L"command_block_side", L"", SWATCH_REPEAT_ALL },
    { 13, 24,   0, L"command_block_conditional", L"", SWATCH_REPEAT_ALL },
    { 14, 24, 210, L"repeating_command_block_front", L"", SWATCH_REPEAT_ALL },
    { 15, 24,   0, L"repeating_command_block_back", L"", SWATCH_REPEAT_ALL },
    {  0, 25,   0, L"repeating_command_block_side", L"", SWATCH_REPEAT_ALL },
    {  1, 25,   0, L"repeating_command_block_conditional", L"", SWATCH_REPEAT_ALL },
    {  2, 25, 211, L"chain_command_block_front", L"", SWATCH_REPEAT_ALL },
    {  3, 25,   0, L"chain_command_block_back", L"", SWATCH_REPEAT_ALL },
    {  4, 25,   0, L"chain_command_block_side", L"", SWATCH_REPEAT_ALL },
    {  5, 25,   0, L"chain_command_block_conditional", L"", SWATCH_REPEAT_ALL },
    {  6, 25, 212, L"frosted_ice_0", L"", SWATCH_REPEAT_ALL },
    {  7, 25,   0, L"frosted_ice_1", L"", SWATCH_REPEAT_ALL },
    {  8, 25,   0, L"frosted_ice_2", L"", SWATCH_REPEAT_ALL },
    {  9, 25,   0, L"frosted_ice_3", L"", SWATCH_REPEAT_ALL },
    { 10, 25, 255, L"structure_block_corner", L"", SWATCH_REPEAT_ALL },
    { 11, 25,   0, L"structure_block_data", L"", SWATCH_REPEAT_ALL },
    { 12, 25,   0, L"structure_block_load", L"", SWATCH_REPEAT_ALL },
    { 13, 25,   0, L"structure_block_save", L"", SWATCH_REPEAT_ALL },
    ...
    { 15, 25,   0, L"water_overlay", L"", SWATCH_REPEAT_ALL },    // 1.9 - water looks like this through glass.
    ...
    {  3, 26,   0, L"bone_block_side", L"", SWATCH_REPEAT_ALL },
    ...
    {  7, 26,   0, L"MWO_chest_latch", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
    {  8, 26,   0, L"water_flow", L"", SWATCH_REPEAT_ALL },	// special: double-wide
    {  9, 26,   0, L"lava_flow", L"", SWATCH_REPEAT_ALL },		// special: double-wide
    ...
    {  1, 30,   0, L"orange_concrete_powder", L"concrete_powder_orange", SWATCH_REPEAT_ALL },
    {  2, 30,   0, L"magenta_concrete_powder", L"concrete_powder_magenta", SWATCH_REPEAT_ALL },
    {  3, 30,   0, L"light_blue_concrete_powder", L"concrete_powder_light_blue", SWATCH_REPEAT_ALL },
    {  4, 30,   0, L"yellow_concrete_powder", L"concrete_powder_yellow", SWATCH_REPEAT_ALL },
    {  5, 30,   0, L"lime_concrete_powder", L"concrete_powder_lime", SWATCH_REPEAT_ALL },
    {  6, 30,   0, L"pink_concrete_powder", L"concrete_powder_pink", SWATCH_REPEAT_ALL },
    {  7, 30,   0, L"gray_concrete_powder", L"concrete_powder_gray", SWATCH_REPEAT_ALL },
    {  8, 30,   0, L"light_gray_concrete_powder", L"concrete_powder_silver", SWATCH_REPEAT_ALL },
    {  9, 30,   0, L"cyan_concrete_powder", L"concrete_powder_cyan", SWATCH_REPEAT_ALL },
    { 10, 30,   0, L"purple_concrete_powder", L"concrete_powder_purple", SWATCH_REPEAT_ALL },
    { 11, 30,   0, L"blue_concrete_powder", L"concrete_powder_blue", SWATCH_REPEAT_ALL },
    { 12, 30,   0, L"brown_concrete_powder", L"concrete_powder_brown", SWATCH_REPEAT_ALL },
    { 13, 30,   0, L"green_concrete_powder", L"concrete_powder_green", SWATCH_REPEAT_ALL },
    { 14, 30,   0, L"red_concrete_powder", L"concrete_powder_red", SWATCH_REPEAT_ALL },
    { 15, 30,   0, L"black_concrete_powder", L"concrete_powder_black", SWATCH_REPEAT_ALL },
    {  0, 31,   0, L"shulker_side_white", L"", SWATCH_REPEAT_ALL },    // optional tiles - BD Craft has them, for example
    {  1, 31,   0, L"shulker_side_orange", L"", SWATCH_REPEAT_ALL },
    {  2, 31,   0, L"shulker_side_magenta", L"", SWATCH_REPEAT_ALL },
    {  3, 31,   0, L"shulker_side_light_blue", L"", SWATCH_REPEAT_ALL },
    {  4, 31,   0, L"shulker_side_yellow", L"", SWATCH_REPEAT_ALL },
    {  5, 31,   0, L"shulker_side_lime", L"", SWATCH_REPEAT_ALL },
    {  6, 31,   0, L"shulker_side_pink", L"", SWATCH_REPEAT_ALL },
    {  7, 31,   0, L"shulker_side_gray", L"", SWATCH_REPEAT_ALL },
    {  8, 31,   0, L"shulker_side_silver", L"", SWATCH_REPEAT_ALL },
    {  9, 31,   0, L"shulker_side_cyan", L"", SWATCH_REPEAT_ALL },
    { 10, 31,   0, L"shulker_side_purple", L"", SWATCH_REPEAT_ALL },
    { 11, 31,   0, L"shulker_side_blue", L"", SWATCH_REPEAT_ALL },
    { 12, 31,   0, L"shulker_side_brown", L"", SWATCH_REPEAT_ALL },
    { 13, 31,   0, L"shulker_side_green", L"", SWATCH_REPEAT_ALL },
    { 14, 31,   0, L"shulker_side_red", L"", SWATCH_REPEAT_ALL },
    { 15, 31,   0, L"shulker_side_black", L"", SWATCH_REPEAT_ALL },
    {  0, 32,   0, L"shulker_bottom_white", L"", SWATCH_REPEAT_ALL },    // optional tiles - BD Craft has them, for example
    {  1, 32,   0, L"shulker_bottom_orange", L"", SWATCH_REPEAT_ALL },
    {  2, 32,   0, L"shulker_bottom_magenta", L"", SWATCH_REPEAT_ALL },
    {  3, 32,   0, L"shulker_bottom_light_blue", L"", SWATCH_REPEAT_ALL },
    {  4, 32,   0, L"shulker_bottom_yellow", L"", SWATCH_REPEAT_ALL },
    {  5, 32,   0, L"shulker_bottom_lime", L"", SWATCH_REPEAT_ALL },
    {  6, 32,   0, L"shulker_bottom_pink", L"", SWATCH_REPEAT_ALL },
    {  7, 32,   0, L"shulker_bottom_gray", L"", SWATCH_REPEAT_ALL },
    {  8, 32,   0, L"shulker_bottom_silver", L"", SWATCH_REPEAT_ALL },
    {  9, 32,   0, L"shulker_bottom_cyan", L"", SWATCH_REPEAT_ALL },
    { 10, 32,   0, L"shulker_bottom_purple", L"", SWATCH_REPEAT_ALL },
    { 11, 32,   0, L"shulker_bottom_blue", L"", SWATCH_REPEAT_ALL },
    { 12, 32,   0, L"shulker_bottom_brown", L"", SWATCH_REPEAT_ALL },
    { 13, 32,   0, L"shulker_bottom_green", L"", SWATCH_REPEAT_ALL },
    { 14, 32,   0, L"shulker_bottom_red", L"", SWATCH_REPEAT_ALL },
    { 15, 32,   0, L"shulker_bottom_black", L"", SWATCH_REPEAT_ALL },
    {  0, 33,   0, L"observer_back", L"", SWATCH_REPEAT_ALL },
    {  1, 33,   0, L"observer_back_on", L"observer_back_lit", SWATCH_REPEAT_ALL },
    {  2, 33,   0, L"observer_front", L"", SWATCH_REPEAT_ALL },
    {  3, 33,   0, L"observer_side", L"", SWATCH_REPEAT_ALL },
    {  4, 33, 218, L"observer_top", L"", SWATCH_REPEAT_ALL },   // alternate name is Sphax BD Craft
    {  5, 33,   0, L"MW_shulker_side", L"", SWATCH_REPEAT_ALL },      // TEMPLATE for sides and bottoms of shulker boxes TODO: someday extract from shulkers in assets\minecraft\textures\entity\shulker
    {  6, 33,   0, L"MW_shulker_bottom", L"", SWATCH_REPEAT_ALL },    // TEMPLATE for sides and bottoms of shulker boxes TODO: someday extract from shulkers in assets\minecraft\textures\entity\shulker
    {  7, 33, 313, L"dried_kelp_top", L"", SWATCH_REPEAT_ALL },  // 1.13 starts here
    {  8, 33,   0, L"dried_kelp_side", L"", SWATCH_REPEAT_ALL },
    {  9, 33,   0, L"dried_kelp_bottom", L"", SWATCH_REPEAT_ALL },
    { 10, 33,   0, L"kelp", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	...
	{  1, 34,   0, L"stripped_spruce_log", L"", SWATCH_REPEAT_ALL },
	{  2, 34,   0, L"stripped_birch_log", L"", SWATCH_REPEAT_ALL },
	{  3, 34,   0, L"stripped_jungle_log", L"", SWATCH_REPEAT_ALL },
	{  4, 34, 278, L"stripped_acacia_log", L"", SWATCH_REPEAT_ALL },
	{  5, 34,   0, L"stripped_dark_oak_log", L"", SWATCH_REPEAT_ALL },
	{  6, 34, 275, L"stripped_oak_log_top", L"", SWATCH_REPEAT_ALL },
	{  7, 34,   0, L"stripped_spruce_log_top", L"", SWATCH_REPEAT_ALL },
	{  8, 34,   0, L"stripped_birch_log_top", L"", SWATCH_REPEAT_ALL },
	{  9, 34,   0, L"stripped_jungle_log_top", L"", SWATCH_REPEAT_ALL },
	{ 10, 34, 276, L"stripped_acacia_log_top", L"", SWATCH_REPEAT_ALL },
	{ 11, 34,   0, L"stripped_dark_oak_log_top", L"", SWATCH_REPEAT_ALL },
	...
	{  2, 35,   0, L"dead_brain_coral_block", L"", SWATCH_REPEAT_ALL },
	{  3, 35,   0, L"dead_bubble_coral_block", L"", SWATCH_REPEAT_ALL },
	{  4, 35,   0, L"dead_fire_coral_block", L"", SWATCH_REPEAT_ALL },
	{  5, 35,   0, L"dead_horn_coral_block", L"", SWATCH_REPEAT_ALL },
	{  6, 35, 315, L"tube_coral_block", L"", SWATCH_REPEAT_ALL },
	{  7, 35,   0, L"brain_coral_block", L"", SWATCH_REPEAT_ALL },
	{  8, 35,   0, L"bubble_coral_block", L"", SWATCH_REPEAT_ALL },
	{  9, 35,   0, L"fire_coral_block", L"", SWATCH_REPEAT_ALL },
	{ 10, 35,   0, L"horn_coral_block", L"", SWATCH_REPEAT_ALL },
	{ 11, 35, 317, L"tube_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 12, 35,   0, L"brain_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 13, 35,   0, L"bubble_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 14, 35,   0, L"fire_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 15, 35,   0, L"horn_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  0, 36,   0, L"tube_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  1, 36,   0, L"brain_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  2, 36,   0, L"bubble_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  3, 36,   0, L"fire_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  4, 36,   0, L"horn_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  5, 36, 319, L"dead_tube_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  6, 36,   0, L"dead_brain_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  7, 36,   0, L"dead_bubble_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  8, 36,   0, L"dead_fire_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  9, 36,   0, L"dead_horn_coral_fan", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 10, 36, 324, L"turtle_egg", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{ 11, 36,   0, L"turtle_egg_slightly_cracked", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{ 12, 36,   0, L"turtle_egg_very_cracked", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{ 13, 36, 322, L"conduit", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{ 14, 36, 325, L"dead_tube_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 15, 36,   0, L"dead_brain_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  0, 37,   0, L"dead_bubble_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  1, 37,   0, L"dead_fire_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  2, 37,   0, L"dead_horn_coral", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  3, 37,   0, L"cornflower", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  4, 37,   0, L"lily_of_the_valley", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  5, 37,   0, L"wither_rose", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  6, 37,   0, L"bamboo_large_leaves", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  7, 37,   0, L"bamboo_singleleaf", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  8, 37,   0, L"bamboo_small_leaves", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  9, 37,   0, L"bamboo_stage0", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },	// X decal
	...
	{ 13, 37,   0, L"sweet_berry_bush_stage1", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 14, 37,   0, L"sweet_berry_bush_stage2", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{ 15, 37,   0, L"sweet_berry_bush_stage3", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  0, 38, 333, L"barrel_top", L"", SWATCH_REPEAT_ALL },
	{  1, 38,   0, L"barrel_side", L"", SWATCH_REPEAT_ALL },
	{  2, 38,   0, L"barrel_bottom", L"", SWATCH_REPEAT_ALL },
	{  3, 38,   0, L"barrel_top_open", L"", SWATCH_REPEAT_ALL },
	{  4, 38, 337, L"bell_top", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{  5, 38,   0, L"bell_side", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{  6, 38,   0, L"bell_bottom", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{  7, 38,   0, L"blast_furnace_top", L"", SWATCH_REPEAT_ALL },
	{  8, 38,   0, L"blast_furnace_side", L"", SWATCH_REPEAT_ALL },
	{  9, 38,   0, L"blast_furnace_front", L"", SWATCH_REPEAT_ALL },
	{ 10, 38,   0, L"blast_furnace_front_on", L"", SWATCH_REPEAT_ALL },
	{ 11, 38, 332, L"composter_top", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{ 12, 38,   0, L"composter_side", L"", SWATCH_REPEAT_ALL },
	{ 13, 38,   0, L"composter_bottom", L"", SWATCH_REPEAT_ALL },
	{ 14, 38,   0, L"composter_compost", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{ 15, 38,   0, L"composter_ready", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{  0, 39, 339, L"campfire_fire", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  1, 39,   0, L"campfire_log", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{  2, 39,   0, L"campfire_log_lit", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
	{  3, 39,   0, L"cartography_table_top", L"", SWATCH_REPEAT_ALL },
	{  4, 39,   0, L"cartography_table_side1", L"", SWATCH_REPEAT_ALL },
	{  5, 39,   0, L"cartography_table_side2", L"", SWATCH_REPEAT_ALL },
	{  6, 39,   0, L"cartography_table_side3", L"", SWATCH_REPEAT_ALL },
	{  7, 39,   0, L"fletching_table_top", L"", SWATCH_REPEAT_ALL },
	{  8, 39,   0, L"fletching_table_side", L"", SWATCH_REPEAT_ALL },
	{  9, 39,   0, L"fletching_table_front", L"", SWATCH_REPEAT_ALL },
	{ 10, 39, 335, L"grindstone_side", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{ 11, 39,   0, L"grindstone_pivot", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{ 12, 39,   0, L"grindstone_round", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{ 13, 39, 331, L"jigsaw_top", L"", SWATCH_REPEAT_ALL },
	{ 14, 39,   0, L"jigsaw_bottom", L"", SWATCH_REPEAT_ALL },	// usually we go top/side/bottom - for command-block sorts of things, we go front/back/side, which is named top/bottom/side here
	{ 15, 39,   0, L"jigsaw_side", L"", SWATCH_REPEAT_ALL },
	{  0, 40, 336, L"lectern_top", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{  1, 40,   0, L"lectern_sides", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{  2, 40,   0, L"lectern_base", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{  3, 40,   0, L"lectern_front", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{  4, 40,   0, L"loom_top", L"", SWATCH_REPEAT_ALL },
	{  5, 40,   0, L"loom_side", L"", SWATCH_REPEAT_ALL },
	{  6, 40,   0, L"loom_bottom", L"", SWATCH_REPEAT_ALL },
	{  7, 40,   0, L"loom_front", L"", SWATCH_REPEAT_ALL },
	{  8, 40, 340, L"scaffolding_top", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{  9, 40,   0, L"scaffolding_side", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{ 10, 40,   0, L"scaffolding_bottom", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },
	{ 11, 40,   0, L"smoker_top", L"", SWATCH_REPEAT_ALL },
	{ 12, 40,   0, L"smoker_side", L"", SWATCH_REPEAT_ALL },
	{ 13, 40,   0, L"smoker_bottom", L"", SWATCH_REPEAT_ALL },
	{ 14, 40,   0, L"smoker_front", L"", SWATCH_REPEAT_ALL },
	{ 15, 40,   0, L"smoker_front_on", L"", SWATCH_REPEAT_ALL },
	{  0, 41,   0, L"smithing_table_top", L"", SWATCH_REPEAT_ALL },
	{  1, 41,   0, L"smithing_table_side", L"", SWATCH_REPEAT_ALL },
	{  2, 41,   0, L"smithing_table_bottom", L"", SWATCH_REPEAT_ALL },
	{  3, 41,   0, L"smithing_table_front", L"", SWATCH_REPEAT_ALL },
	{  4, 41, 334, L"stonecutter_top", L"", SWATCH_REPEAT_ALL },
	{  5, 41,   0, L"stonecutter_side", L"", SWATCH_CLAMP_ALL_BUT_TOP | SBIT_CUTOUT_GEOMETRY },
	{  6, 41,   0, L"stonecutter_bottom", L"", SWATCH_REPEAT_ALL },
	{  7, 41,   0, L"stonecutter_saw", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
