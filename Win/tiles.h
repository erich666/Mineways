...
static struct {
    ...
    {  0, 57, 436, 0, L"calibrated_sculk_sensor_amethyst", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },    // start of 1.20
    {  1, 57, 388, 0, L"calibrated_sculk_sensor_input_side", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_CUTOUT_GEOMETRY },
    {  2, 57,   3, 0, L"calibrated_sculk_sensor_top", L"", SWATCH_REPEAT_ALL },
    {  3, 57,   3, 0, L"cherry_door_bottom", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    {  4, 57,   3, 0, L"cherry_door_top", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    {  5, 57,   3, 0, L"cherry_leaves", L"", SWATCH_REPEAT_ALL | SBIT_DECAL | SBIT_LEAVES },
    ...
    {  9, 57, 433, 0, L"cherry_sapling", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    { 10, 57, 433, 0, L"cherry_trapdoor", L"", SWATCH_REPEAT_ALL | SBIT_DECAL },
    { 11, 57, 433, 0, L"pink_petals", L"", SWATCH_REPEAT_ALL | SBIT_DECAL },
    { 12, 57, 434, 0, L"pink_petals_stem", L"", SWATCH_CLAMP_ALL | SBIT_CUTOUT_GEOMETRY },    // stem is along left edge
    { 13, 57, 388, 0, L"pitcher_crop_bottom", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 14, 57, 388, 0, L"pitcher_crop_bottom_stage_1", L"", SBIT_CLAMP_TOP | SBIT_CUTOUT_GEOMETRY },
    { 15, 57, 388, 0, L"pitcher_crop_bottom_stage_2", L"", SBIT_CLAMP_TOP | SBIT_CUTOUT_GEOMETRY },
    {  0, 58, 436, 0, L"pitcher_crop_bottom_stage_3", L"", SBIT_CLAMP_TOP | SBIT_CUTOUT_GEOMETRY },
    {  1, 58, 388, 0, L"pitcher_crop_bottom_stage_4", L"", SBIT_CLAMP_TOP | SBIT_CUTOUT_GEOMETRY },
    {  2, 58,   3, 0, L"pitcher_crop_side", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  3, 58,   3, 0, L"pitcher_crop_top", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  4, 58,   3, 0, L"pitcher_crop_top_stage_3", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  5, 58,   3, 0, L"pitcher_crop_top_stage_4", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  6, 58,   3, 0, L"sniffer_egg_not_cracked_bottom", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  7, 58, 433, 0, L"sniffer_egg_not_cracked_east", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  8, 58, 433, 0, L"sniffer_egg_not_cracked_north", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  9, 58, 433, 0, L"sniffer_egg_not_cracked_south", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 10, 58, 433, 0, L"sniffer_egg_not_cracked_top", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 11, 58, 433, 0, L"sniffer_egg_not_cracked_west", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 12, 58, 434, 0, L"sniffer_egg_slightly_cracked_bottom", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 13, 58, 388, 0, L"sniffer_egg_slightly_cracked_east", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 14, 58, 388, 0, L"sniffer_egg_slightly_cracked_north", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 15, 58, 388, 0, L"sniffer_egg_slightly_cracked_south", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  0, 59, 436, 0, L"sniffer_egg_slightly_cracked_top", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  1, 59, 388, 0, L"sniffer_egg_slightly_cracked_west", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  2, 59,   3, 0, L"sniffer_egg_very_cracked_bottom", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  3, 59,   3, 0, L"sniffer_egg_very_cracked_east", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  4, 59,   3, 0, L"sniffer_egg_very_cracked_north", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  5, 59,   3, 0, L"sniffer_egg_very_cracked_south", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  6, 59,   3, 0, L"sniffer_egg_very_cracked_top", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    {  7, 59, 433, 0, L"sniffer_egg_very_cracked_west", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    ...
    {  0, 60, 436, 0, L"suspicious_sand_2", L"", SWATCH_REPEAT_ALL },
    {  1, 60, 388, 0, L"suspicious_sand_3", L"", SWATCH_REPEAT_ALL },
    {  2, 60,   3, 0, L"torchflower", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  3, 60,   3, 0, L"torchflower_crop_stage0", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  4, 60,   3, 0, L"torchflower_crop_stage1", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  5, 60,   3, 0, L"bamboo_block", L"", SWATCH_REPEAT_ALL },
    {  6, 60,   3, 0, L"bamboo_block_top", L"", SWATCH_REPEAT_ALL },
    {  7, 60,   0, 0, L"bamboo_door_bottom", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    {  8, 60,   0, 0, L"bamboo_door_top", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_DECAL },
    {  9, 60,   0, 0, L"bamboo_fence", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    { 10, 60,   0, 0, L"bamboo_fence_gate", L"", SWATCH_REPEAT_ALL | SBIT_CUTOUT_GEOMETRY },
    ...
    { 15, 60,   0, 0, L"bamboo_trapdoor", L"", SWATCH_REPEAT_ALL | SBIT_DECAL },
    {  0, 61, 436, 0, L"decorated_pot_side", L"", SWATCH_REPEAT_SIDES_ELSE_CLAMP | SBIT_CUTOUT_GEOMETRY },
    {  1, 61, 388, 0, L"MW_decorated_pot_base1", L"", SWATCH_REPEAT_ALL },
    {  2, 61,   3, 0, L"MW_decorated_pot_base2", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  3, 61,   3, 0, L"MW_decorated_pot_base3", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  4, 61,   3, 0, L"MW_decorated_pot_base4", L"", SBIT_CLAMP_BOTTOM | SBIT_DECAL },
    {  5, 61,   3, 0, L"", L"", SWATCH_REPEAT_ALL },
    {  6, 61,   3, 0, L"", L"", SWATCH_REPEAT_ALL },
    {  7, 61,   0, 0, L"", L"", SWATCH_REPEAT_ALL },
    {  8, 61,   0, 0, L"", L"", SWATCH_REPEAT_ALL },
    {  9, 61,   0, 0, L"", L"", SWATCH_REPEAT_ALL },
    { 10, 61,   0, 0, L"", L"", SWATCH_REPEAT_ALL },
